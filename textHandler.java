...
c.sendQuest("Rushed-owns Highscores", 6399);
c.sendQuest("Rushed-owns", 640);
...
c.sendFrame126("The Bank of Rushed-owns - Deposit Box", 7421);
c.sendQuest("The Bank of Rushed-owns - Bank Pin", 14923);
c.sendQuest("", 15107);
c.sendQuest("Set Pin", 15078);
c.sendQuest("Delete Pin", 15082);
c.sendQuest("", 15107);
c.sendQuest("Set Pin", 15078);
c.sendQuest("@blu@The Bank of Rushed-owns",5383);
c.sendQuest("",4439);
c.sendQuest("Pest control", 10361);
c.sendQuest("Current points:", 10378);
c.sendQuest("Blue robes", 10374);
c.sendQuest("Toy horse's", 10375);
c.sendQuest("100 points", 10376);
c.sendQuest("100 points", 10377);
c.sendQuest("White robes", 6557);
c.sendQuest("100 points", 6559);
c.sendQuest("Green robes", 16159);
c.sendQuest("100 points", 16160);
c.sendQuest("Close Window", 15949);//Close Text
c.sendQuest("      Rushed-owns", 15950);//Title
...
c.sendQuest("www.chivalry.forum-pro.co.uk is the forums!", 15952);//Bottom banner- bottom line
